...
describe('UserService', () => {
  ...
  const mockUser = { id: 1, name: 'User 1' , roles: [Role.Viewer], collection:[{ id: 1, name: 'Collection 1', genre: undefined, releaseDate: undefined,owner:1 }, { id: 2, name: 'Collection 2' , genre: undefined, releaseDate:undefined,owner:1 }]};
  const mockCollection = [{ id: 1, name: 'Collection 1', genre: undefined, releaseDate: undefined ,owner:1 }, { id: 2, name: 'Collection 2' , genre: undefined, releaseDate: undefined,owner:1 }];
